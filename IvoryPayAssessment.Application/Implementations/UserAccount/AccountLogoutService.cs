...
namespace IvoryPayAssessment.Application.Implementations.UserAccount
{
    ...
    public class AccountLogoutService : ResponseBaseService, IAccountLogoutService
    {
        ...
        public AccountLogoutService(IMessageProvider messageProvider, IHttpContextAccessor httpContext, SignInManager<ApplicationUser> signInManager, ILogger<AccountLogoutService> logger, ISessionsService sessionsService, IConfiguration config, UserManager<ApplicationUser> userManager,
